...
You need Java 8 or above for this utility to work. Download and copy the utility class into your workspace (_If needed rename the package to your desired project structure_). This utility consists of a single class file that needs no other dependencies and is self-sufficient. If your organization has any security restrictions, you need not worry about it as you will not be using any other third-party jars that may otherwise impose security alerts. This is indeed a very lightweight utility that should fulfill business needs. 
